...
urlpatterns = [
    ...
    path('role/set/menu', set_role_menu, name='set_role_menu'),
    path('role/menu/list', get_menu_list_by_role, name='get_menu_list_by_role'),
    ...
    path('permission/self', get_self_permission, name='get_self_permission'),
]
